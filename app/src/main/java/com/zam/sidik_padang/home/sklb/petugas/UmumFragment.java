...
import com.zam.sidik_padang.databinding.FragmentSklbPetugasUmumBinding;
...
public class UmumFragment extends SklbBaseFragment implements PetugasCallback {

    private FragmentSklbPetugasUmumBinding binding;
    private PeternakAdapter adapter;
    private List<PeternakUmum> peternakUmums;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentSklbPetugasUmumBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NotNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        peternakUmums = new ArrayList<>();
        adapter = new PeternakAdapter(peternakUmums, this);
        ...
        petugasViewModel.getResponseData().observe(getViewLifecycleOwner(), petugasResponseResponseData -> {
            if (petugasResponseResponseData != null) {
                if (petugasResponseResponseData.success && petugasResponseResponseData.data != null) {
                    peternakUmums = petugasResponseResponseData.data.getPeternakUmum();
                    success();
