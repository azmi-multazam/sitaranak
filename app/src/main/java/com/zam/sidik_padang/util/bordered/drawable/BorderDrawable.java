package com.zam.sidik_padang.util.bordered.drawable;
...
public class BorderDrawable extends Drawable {
    ...
    private int mLeftBorderColor = Color.parseColor("#28A352");
    private int mRightBorderColor = Color.parseColor("#28A352");

    private int mTopBorderWidth = 0;
    private int mBottomBorderWidth = 0;
    private int mTopBorderColor = Color.parseColor("#28A352");
    private int mBottomBorderColor = Color.parseColor("#28A352");

    private int mFillBackground = Color.WHITE;
    ...
    public int getFillBackground() {
        return mFillBackground;
    }

    public void setFillBackground(int mFillBackground) {
        this.mFillBackground = mFillBackground;
    }
