...
public class PaketInternetActivity extends BaseLogedinActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listJenisVoucher.addAll(DataHelper.getDataHelper(this).getProdukPaketNet());
        ...
        apiHelper.getProdukPaketNet(new ApiHelper.OnDoneListener() {
            ...
            public void onDone(boolean success) {
                if (success) {
                    ...
                    listJenisVoucher.addAll(DataHelper.getDataHelper(PaketInternetActivity.this).getProdukPaketNet());
    ...
    private void loadProdukPilihan() {
        ...
        String url = Config.URL_PPOB + "userid=" + user.userid + "&aksi=2&code=" + ((ProdukPaketNet) listJenisVoucher.get(selectedProdukPulsa)).code;
    ...
    private void prosesPembelian() {
        ...
        String url = Config.URL_PROSES +
                ...
                "&kode=" + ((ProdukPaketNet) listJenisVoucher.get(selectedProdukPulsa)).code +
		 ...
		 */
        editTextPin.setText("");
        debug(getClass(), "Proses beli pket net url= " + url);
        ...
        VolleyStringRequest request = new VolleyStringRequest(url, new VolleyStringRequest.Callback() {
            ...
            public void onResponse(final JsonObject jsonObject) {
                ...
                if (isResummed) new AlertDialog.Builder(PaketInternetActivity.this)
