...
public class ProfileLengkapActivity extends BaseActivity
    ...
    private final boolean daftar = false;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_lengkap);
        ...
        editTextNama = findViewById(R.id.activity_tambah_peternak_EditTextName);
        editTextKtp = findViewById(R.id.activity_tambah_peternak_EditTextKTP);
//		editTextHp = (EditText) findViewById(R.id.activity_tambah_peternak_EditTextHP);
        editTextEmail = findViewById(R.id.activity_tambah_peternak_EditTextEmail);
        editTextKodePos = findViewById(R.id.activity_tambah_peternak_EditTextPostCode);
        editTextAlamat = findViewById(R.id.activity_tambah_peternak_EditTextAddress);
        editTextTempatLahir = findViewById(R.id.activity_tambah_peternak_EditTextTempatLahir);
        editTextTanggalLahir = findViewById(R.id.activity_tambah_peternak_EditTextBirthday);
        editTextPekerjaan = findViewById(R.id.activity_tambah_peternak_EditTextEmployment);
        editTextIbuKandung = findViewById(R.id.activity_tambah_peternak_EditTextMother);
        editTextNamaUsaha = findViewById(R.id.activity_tambah_peternak_EditTextNamaUsaha);
        editTextLokasiUsaha = findViewById(R.id.activity_tambah_peternak_EditTextLokasiUsaha);
        editTextHpPeternakan = findViewById(R.id.activity_tambah_peternak_EditTextHpPeternakan);
        editTextEmailPeternakan = findViewById(R.id.activity_tambah_peternak_EditTextEmailPeternakan);
        editTextNamaOlahan = findViewById(R.id.activity_tambah_peternak_EditTextNamaOlahan);

        AppCompatSpinner spinnerProvinsi = findViewById(R.id.activity_tambah_peternak_SpinnerProvinsi);
        spinnerKabupaten = findViewById(R.id.activity_tambah_peternak_SpinnerKaBupaten);
        spinnerKecamatan = findViewById(R.id.activity_tambah_peternak_SpinnerKecamatan);
        spinnerDesa = findViewById(R.id.activity_tambah_peternak_SpinnerDesa);
        AppCompatSpinner spinnerStatusPernikahan = findViewById(R.id.activity_tambah_peternak_SpinnerPernikahan);
        AppCompatSpinner spinnerJenisKelamin = findViewById(R.id.activity_tambah_peternak_SpinnerGender);
        AppCompatSpinner spinnerAgama = findViewById(R.id.activity_tambah_peternak_SpinnerReligion);
        AppCompatSpinner spinnerLevel = findViewById(R.id.activity_tambah_peternak_SpinnerLevel);

        AppCompatSpinner spinnerStatusPeternakan = findViewById(R.id.activity_tambah_peternak_SpinnerStatusPeternakan);
        AppCompatSpinner spinnerKelompok = findViewById(R.id.activity_tambah_peternak_SpinnerKelompok);
        AppCompatSpinner spinnerNamaKelompok = findViewById(R.id.activity_tambah_peternak_SpinnerNamaKelompok);
        AppCompatSpinner spinnerJenisKomoditas = findViewById(R.id.activity_tambah_peternak_SpinnerJenisKomoditas);
        AppCompatSpinner spinnerJenisUsaha = findViewById(R.id.activity_tambah_peternak_SpinnerJenisUsaha);
        AppCompatSpinner spinnerProdukPenjualan = findViewById(R.id.activity_tambah_peternak_SpinnerProdukPenjualan);
        ...
        progressBarFoto = findViewById(R.id.activity_tambah_peternak_ProgressbarFoto);
        ...
        imageViewFoto = findViewById(R.id.activity_tambah_peternak_ImageViewFoto);
        imageViewFoto.setOnClickListener(this);
        textViewFoto = findViewById(R.id.activity_tambah_peternak_TextViewFoto);
        ...
        VolleyStringRequest request = new VolleyStringRequest(url, new VolleyStringRequest.Callback() {
            ...
            public void onResponse(JsonObject jsonObject) {
                ...
                if (jsonObject.get("success").getAsBoolean()) {
                    ...
                    Toast.makeText(ProfileLengkapActivity.this, jsonObject.get("message").getAsString(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        VolleyStringRequest request = new VolleyStringRequest(url, new VolleyStringRequest.Callback() {
            ...
            public void onResponse(JsonObject jsonObject) {
                ...
                if (jsonObject.get("success").getAsBoolean()) {
                    JsonElement je = jsonObject.get("kelompok_ternak");
                    if (je == null) return;
                    if (listNamaKelompok.size() > 1) {
                        listNamaKelompok.subList(1, listNamaKelompok.size()).clear();
                    }
                    JsonArray array = je.getAsJsonArray();
                    Map<String, String> map;
                    for (JsonElement element : array) {
        ...
        VolleyStringRequest request = new VolleyStringRequest(url, new VolleyStringRequest.Callback() {
            ...
            public void onResponse(JsonObject jsonObject) {
                ...
                if (jsonObject.get("success").getAsBoolean()) {
                    ...
                    adapterSpinnerProvinsi.notifyDataSetChanged();
                    Db.getInstance(ProfileLengkapActivity.this).saveprovinsi(array);
                } else {
                    debug(getClass(), "error_message: " + jsonObject.get("message").getAsString());
    ...
    public void onClick(View p1) {
        ...
        if (id == R.id.activity_tambah_peternak_EditTextBirthday) {
            ...
            validateAndGo();
        } else if (id == R.id.activity_tambah_peternak_ImageViewFoto) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                    new AlertDialog.Builder(this).setMessage(R.string.need_to_access_media_storage).setPositiveButton(android.R.string.ok,
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    ActivityCompat.requestPermissions(ProfileLengkapActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 12);
                                }
                            }).show();
                } else
    ...
    private void validateAndGo() {
        ...
        if (selectedProvinsi == 0) {
            Util.showDialog(this, getString(R.string.please_select_provinsi));
            return;
        }
        url += "&provinsi=" + listProvinsi.get(selectedProvinsi).get("id");
            ...
            public void onResponse(JsonObject jsonObject) {
                ...
                if (jsonObject.get("success").getAsBoolean()) {
                    ...
                    if (ja.size() > 0) {
                        ...
                        Util.saveUserDetail(ProfileLengkapActivity.this, jsonMember);
                        Toast.makeText(ProfileLengkapActivity.this, jsonObject.get("message").getAsString(), Toast.LENGTH_SHORT).show();
                        Intent it = new Intent(ProfileLengkapActivity.this, MainActivity.class);
                    ...
                    if (isResummed) {
                        ...
                        Util.showDialog(ProfileLengkapActivity.this, je == null ? getString(R.string.an_error_ocurred) : je.getAsString());
                    }
                }
            }
        });
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(this)
                ...
                .setNegativeButton("Batalkan", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(ProfileLengkapActivity.this).edit();
                        editor.remove(Config.PREF_NOMOR_HP);
                        editor.remove(Config.PREF_WAKTU_DAFTAR);
                        editor.apply();
                        Intent intent = new Intent(ProfileLengkapActivity.this, LoginActivity.class);
    ...
    private class CustomSpinnerListener extends SpinnerListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            } else if (viewId == R.id.activity_tambah_peternak_SpinnerKaBupaten) {
