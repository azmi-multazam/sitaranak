...
public class VolleyMultipartRequest extends Request<NetworkResponse> {
    ...
    public VolleyMultipartRequest(String url, Map<String, String> headers, final Callback callback) {
        super(Method.POST, url, new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                String errorMessage = error.getMessage() == null ? "Check your internet connnection" : error.getMessage();
    ...
    protected void deliverResponse(NetworkResponse response) {
        ...
        callback.onResponse(new Gson().fromJson(string, JsonElement.class).getAsJsonObject());
    }
    ...
    private void buildDataPart(DataOutputStream dataOutputStream, DataPart dataFile, String inputName) throws IOException {
        ...
        int kb = 1;
        while (bytesRead > 0) {
            callback.onProgressUpdate(kb, totalKb);
            kb++;
