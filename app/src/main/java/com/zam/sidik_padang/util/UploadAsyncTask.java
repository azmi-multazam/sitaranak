...
// open a URL connection to the Servlet
        try {
            ...
            conn.setRequestProperty("ao", sourceFile.getName());
            ...
            dos.writeBytes("Content-Disposition: form-data; name=\"ao\";filename=" + sourceFile.getName() + "" + lineEnd);
            ...
            JsonElement je = (new Gson()).fromJson(hasil, JsonElement.class);
